...
class Notificacion(models.Model):
    ...
    tipo = models.CharField(max_length=20, choices=(('aceptada', 'Aceptó solicitud'), ('rechazada', 'Rechazó solicitud')))
    foto_amigo = models.ImageField(upload_to='fotos_amigos', null=True, blank=True)

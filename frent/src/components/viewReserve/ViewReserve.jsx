...
export default function ViewReserve() {
  ...
  const getClientName = (clientId) => {
    const client = listClient.find(
      (clientName) => clientName.id_user === clientId
    );
    if (client) {
              ...
              <div
                ...
                <div className="pending-info">
                  <div className="user-info">
                    ...
                    />
                    <p className="time">
                      Hace {calculateTimePassed(rent.create)}
                    </p>
                  </div>
                ...
                <div className="action-buttons">
                  <button
                    className="btnV"
                    onClick={() =>
                      handleAccept(rent.id, rent.client, rent.friend)
                    }>
                    Aceptar
                  </button>
                  <button
                    className="btnVR"
                    onClick={() =>
                      handleReject(rent.id, rent.client, rent.friend)
                    }>
                    Rechazar
                  </button>
                </div>

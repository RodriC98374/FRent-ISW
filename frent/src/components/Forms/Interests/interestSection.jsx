...
const InterestModal = ({ onSaveInterests }) => {
    ...
    const handleInterestSelect = (interest) => {
        ...
        if (interestIndex === -1) {
            ...
            const updatedSelectedLikes = selectedLikes.filter(id => id !== interest.id);
        ...
        <>
            <div className="interest-body">
                <div className="interest">
                    ...
                    <div className="col2">
                        <button className="addInterest" onClick={(e) => { e.preventDefault(); handleShowModal(); }}>Agregar intereses</button>
                        ...
                        <div className="modal-content">
                            <ul className="tags-grid">
                                {likes.map((like, index) => (
                                    <li
                                        className={`customerInteres ${selectedLikes.includes(like.id) ? 'selected-interest' : ''}`}
                                        key={index}
